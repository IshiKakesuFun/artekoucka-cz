import { PriCheckmark } from "@icons";
export default function Competence() {
  return (
    <section class="section-competence" id="kompetence">
      <div class="container">
        <h2 class="heading-2">Kompetence</h2>
        ...
        <ul class="list">
          <li class="list-item">
            ...
            <p class="competence-text">
              ...
              <strong>
                Učitelství pro SŠ (psychologie a výtvarná výchova)
              </strong>{" "}
              – Mgr.
            </p>
          </li>
        ...
        <ul class="list">
          <li class="list-item">
            ...
            <p class="competence-text">
              2021 – 2022 –{" "}
              <strong>
                Výcvik výtvarné exprese pro děti i dospělé dle Arno Sterna
              </strong>{" "}
              (garantováno ČAA)
            </p>
          </li>
          ...
          <li class="list-item">
            ...
            <p class="competence-text">
              2021 –{" "}
              <strong>
                Jak nastartovat výtvarné myšlení žáků na druhém stupni ZŠ
              </strong>
              (webinář RVP, online)
            </p>
          </li>
          <li class="list-item">
            ...
            <p class="competence-text">
              ...
              hod, rekvalifikační program, Síť pro rodinu, z. s., Plzeň,
              akreditováno MŠMT)
            </p>
          </li>
          <li class="list-item">
            ...
            <p class="competence-text">
              ...
              (4 týdenní online kurz, Radka Rubešová)
            </p>
          </li>
          <li class="list-item">
            <PriCheckmark class="list-icon" />
          ...
          <li class="list-item">
            ...
            <p class="competence-text">
              2013 –{" "}
              <strong>
                Kurz kreslení tužkou za pomoci pravé mozkové hemisféry (PMH) a
                Montessori pedagogi
              </strong>{" "}
              (16 hod, KK Serafin, s. r. o., Praha, akreditováno MŠMT)
            </p>
          </li>
          <li class="list-item">
            <PriCheckmark class="list-icon" />
            <p class="competence-text">
              2013 –{" "}
              <strong>
                Výtvarný projev a jeho souvislosti s osobností dítěte
              </strong>{" "}
              (8 hod., NIDV, Karlovy Vary, akreditováno MŠMT)
            </p>
          </li>
          <li class="list-item">
            <PriCheckmark class="list-icon" />
            <p class="competence-text">
              ...
              (16 hod, NIDV, Plzeň, akreditováno MŠMT)
            </p>
          </li>
          <li class="list-item">
            <PriCheckmark class="list-icon" />
