...
export const defautlTestimonials: TestimonialType[] = [
  ...
  {
    text:
      "Koučing s Martou? Dlouho jsem si říkala - kéž by mi řekla, co si o tom myslí. Ona mi to neřekla. Ale dovedla mě k tomu, co si o tom myslím já. Nakonec jsem měla pocit, že každý problém má řešení a to řešení Marta pomůže najít ve vás samotných. A možná si i zalítáte…",
